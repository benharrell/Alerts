...
- (void)mapView:(MKMapView *)mapView didUpdateUserLocation:(MKUserLocation *)userLocation
{
    ...
    CLLocationCoordinate2D coord = {.latitude= userLocation.coordinate.latitude, .longitude =  userLocation.coordinate.longitude};
    // 2
    MKCoordinateRegion viewRegion = MKCoordinateRegionMakeWithDistance(coord, self.radiusInMiles*METERS_PER_MILE, self.radiusInMiles*METERS_PER_MILE);
    ...
    [self processNewLocation:userLocation.location];
...
-(void)alertView:(UIAlertView *)alertView willDismissWithButtonIndex:    (NSInteger)buttonIndex
{
    ...
    else if(buttonIndex==2) //details
    {
        ...
        //wdAlertLocation *selectedLoc = (wdAlertLocation *)alertView.annotation;
